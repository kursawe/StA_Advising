function write_honours_timetable(file_1,year)
...
semester='S2'; make_timetable_instance(M,semester,year);
    ...
    function make_timetable_instance(M,semester,year)
        ...
        writetable(T_odd,'output-timetable.xlsx','Sheet',strcat(semester,'_',year),'Range','A1')
        writetable(T_even,'output-timetable.xlsx','Sheet',strcat(semester,'_',year),'Range','E1')
        writetable(T_other,'output-timetable.xlsx','Sheet',strcat(semester,'_',year),'Range','I1')
    end
